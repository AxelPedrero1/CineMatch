...
public final class Tool1Panel extends JPanel {
    ...
    // Constructeur de compatibilité pour l'ancien code/tests
    public Tool1Panel(final MovieRecommenderService service,
                      final app.cinematch.ui.swing.MainFrame parent) {
        this(service, java.util.Objects.requireNonNull(parent, "parent must not be null")::showCard);
    }
    ...
    /** Construction sans String.format pour éviter VA_FORMAT_STRING_USES_NEWLINE. */
